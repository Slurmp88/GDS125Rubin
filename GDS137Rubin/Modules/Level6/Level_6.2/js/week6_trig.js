...
function animate()
{
	...
	var angle;
	if(pearl.distance(player) <= 300)
	{
		angle = pearl.getAngle(player);
		console.log(pearl.distance(player))
		if(pearl.distance(player) < 5)
		{
			pearl.x = 10000000
		}
		pearl.x += Math.cos(angle)* 10;
		pearl.y += Math.sin(angle)* 10;
	}
	//--------------------------------------------------------------------------------------------------------------------------
	//------------------------------------------------------END OF INSTRUCTIONS-------------------------------------------------
	//--------------------------------------------------------------------------------------------------------------------------
